...
# skeleton = [[6, 5], [5, 4], [1, 2], [2, 3], [4, 7], [7, 3], [4, 14], [3, 13], [14, 8],
#             [8, 13], [14, 15], [13, 12], [15, 16], [12, 11], [8, 9], [9, 10]]
# pose_palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
#                          [153, 204, 255], [255, 102, 255], [255, 51, 255], [102, 178, 255], [51, 153, 255],
#                          [255, 153, 153], [255, 102, 102], [255, 51, 51], [153, 255, 153], [102, 255, 102],
#                          [51, 255, 51], [0, 255, 0]], dtype=np.uint8)
# kpt_color = pose_palette[[16, 16, 16, 16, 16, 0, 0, 0, 0, 0, 0, 9, 9, 9, 9, 9]]
# limb_color = pose_palette[[9, 9, 9, 9, 7, 7, 7, 0, 0, 0, 0, 0, 16, 16, 16, 16, 16, 16]]
...
if __name__ == "__main__":
    ...
    img = cv2.imread("./all/ztest/11111.jpg")
    # img = add_noise(img)
    img_pre, IM = preprocess_warpAffine(img)
    # img = preprocess_letterbox(img)


    model = AutoBackend(weights="runs/pose/train62/weights/best.pt")
    # model = AutoBackend(weights="yolov8s-pose.pt")
    from ultralytics.nn.tasks import PoseModel, attempt_load_one_weight
    from ultralytics import YOLO
    # we, ck = attempt_load_one_weight('yolov8s-pose.pt')
    # model = PoseModel('yolov8s-pose.yaml')
    ...
    for box in boxes:
        ...
        caption = f"{confidence:.2f}"  # {names[label]}
    ...
    end_time3 = time.time()
    print(start_time-end_time1, '/n', end_time1-end_time2, '/n', end_time2-end_time3)
    cv2.imwrite("./all/zour/11111.jpg", img)
    print("save done")
